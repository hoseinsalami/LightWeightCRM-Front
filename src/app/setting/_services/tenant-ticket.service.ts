...
import {CreateTenantTicketDTO, EditTenantTicketDTO} from "../_types/createTenantTicketDTO";
import {Observable} from "rxjs";

@Injectable({
  providedIn: 'root'
})
export class TenantTicketService extends BaseCrudService {

  override baseUrl = environment.apiUrl + 'CRM/TenantTicket'
